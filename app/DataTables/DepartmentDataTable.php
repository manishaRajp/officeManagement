    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                return
                    '<br><a href="' . route("admin.department.edit", $data->id) . '"class="btn btn-outline-info"><i class="fa fa-pencil"></i></a>
                     <button type="button" id="delete_department" data-id= "' . $data->id . '"class="btn btn-outline-danger"><i class="fa fa-trash"></i></button>
                    ';
            })
